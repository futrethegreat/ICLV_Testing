...
public class ICLVPayablesPage {
	...
	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "ot80") })
	// @FindBy(id = "ot80")
	public WebElement tblInvoices;

	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"),
	...
	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "PAYAMT") })
	// @FindBy(id = "PAYAMT")
	public WebElement txtAmount;

	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "execute1") })
	// @FindBy(id = "execute1")
	public WebElement btnExecute;

	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "confirmok") })
	// @FindBy(id = "confirmok")
	public WebElement btnConfirmOK;

	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "refreshicon") })
	...
	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "confirmmsg") })
	// @FindBy(id = "confirmmsg")
	public WebElement lblConfirmMsg;

	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "confirmcode") })
	// @FindBy(id = "confirmcode")
	public WebElement txtConfirmCode;

	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "confirmpassword") })
	// @FindBy(id = "confirmpassword")
	public WebElement txtConfirmPassword;

	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "note") })
	// @FindBy(id = "note")
	public WebElement txtNoteBox;

	@FindBys({ @FindBy(xpath = ".//*[@id=\"208|65|PE20170040938\"]/div"), @FindBy(id = "disputeamount") })
	...
	public String clickTblInvoices1stRowNotDisputed(WebDriver driver, String supplier) {
		...
		for (int i = 1; i < tableRows.size(); i++) {
			...
			// Utils.consoleMsg(rowCells.get(0).getText() + " - " +
			// rowCells.get(11).getText());
	...
	public String getLblErrorAmount(WebDriver driver) {
		// Returns Please enter a numeric payment amount between zero and the invoice
		// exposure
